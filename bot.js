...
client.on('guildMemberRemove', member => {
    ...
    var channel =member.guild.channels.find('name', 'bots')
    if (!channel) return;
...
antispam(client, {
  ...
  warningMessage: "توقف عن الاسبام الا هتبلع ميوت.", // رسالة تحذير اذا سوا سبام!
  roleMessage: "تم اعطاءك ميوت!!", // الرسالة الي تجي اذا شخص اخذ ميوت
  roleName: "Muted", // اسم رتبة الميوت
  maxDuplicatesWarning: 6, // عدد الرسايل الي قبل التحذيرات
  maxDuplicatesBan: 7, // عدد الرسايل الي يقدر المستخدم يرسلها قبل الميوت
  time: 900000, // عدد الوقت الي يجلس لين تسحب رتبة الميوت من الشخص الحسبة برمجية وليست كتابية 
});
